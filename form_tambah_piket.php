	    ...
	    <div id="content-wrapper">
	        <div class="container-fluid">
	          	...
	          	<ol class="breadcrumb">
	            	...
	            	<li class="breadcrumb-item active">Tambah Jadwal Piket</li>
	          	</ol>
	            ...
	            <table class="card-body" id="dataTable" width="100%" cellspacing="0">
		  		    <tr>
			            ...
			            <td class="td">:</td>
			            <td width="70%"><label class="edit"><input type="text" name="nim" class="form-control" maxlength='8' required="required" style="background-color: white;"></label></td>
		  		    </tr>
		  		    <tr>
		  		    ...
		  		    <tr>
			            <td><label class="data bg-white">Tanggal Piket</label></td>
			            <td class="td">:</td>
			            <td><label class="edit"><input type="date" name="tanggal_piket" class="form-control" maxlength='50' required="required"></label></td>
		  		    </tr>
		  		    <tr>
			            <td><label class="data bg-white">Jenis Piket</label></td>
			            <td class="td">:</td>
			            <td>
			            	<label class="edit">
			            	<select name="jenis_piket" class="form-control" maxlength='50' required="required" style="background-color: white;">
			            		<option>Cuci Piring</option>
			            		<option>Piket Alat dan Meja</option>
			            		<option>Sedot Debu Karpet</option>
			            	</select>
			            	</label>
			            </td>
		  		    </tr>
