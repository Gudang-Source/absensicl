<?php
  ...
  $pdf->SetTitle('Laporan Absensi Harian');
  $pdf->AliasNbPages();
  ...
  //Query Ke Database
  $query="SELECT tb_user.nim, tb_user.nama_anggota, tb_user.id_sidikjari,tgl_absensi, waktu_datang, IF (waktu_datang<='10:00:00','Hadir', IF(waktu_datang<='17:00:00','Telat','Tidak Hadir')) AS status_absensi FROM absensi join tb_user on tb_user.nim = absensi.nim where day(tgl_absensi)=$day order by waktu_datang ASC";
